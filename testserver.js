...
function handleConnection(conn) {
  ...
  let interval = setInterval(function() {
    console.log("Data sent.")
  	let data = "<nowplaying><sched_time>55533940</sched_time><air_time>55611000</air_time><stack_pos></stack_pos><title>Heathens</title><artist>twenty one pilots</artist><trivia></trivia><category>MNZ</category><cart>B31C</cart><intro>1000</intro><end></end><station>97.1</station><duration>187300</duration><media_type>SONG</media_type><milliseconds_left></milliseconds_left><Album>Suicide Squad (soundtrack)</Album><Ending>S</Ending><Field2></Field2><ISRC>USAT21601930</ISRC><Label>FBR/RRP</Label><Tempo></Tempo><YearSG>2016</YearSG></nowplaying>";
    conn.write(data);
    if (connected == false) {
